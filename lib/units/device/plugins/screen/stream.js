...
module.exports = syrup.serial()
  ...
  .define(function(options, adb, minicap, display, screenOptions) {
    ...
    FrameProducer.prototype.updateProjection = function(width, height) {
      ...
      log.info('========> but fixed to %dx%d', 800, 800)  // Temporary
      this.frameConfig.virtualWidth = 800
      this.frameConfig.virtualHeight = 800
      this._configChanged()
    }
    ...
    FrameProducer.prototype._startService = function() {
      log.info('Launching screen service %s', util.format(
          '-S -Q %d -P %s'
